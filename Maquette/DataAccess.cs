...
namespace Maquette /// A MODIFIER SI VOTRE PROJET A UN AUTRE NOM
{
    ...
    public class DataAccess
   {
      ...
      public bool OpenConnection()
      {
          try
          {
              ...
              {
                  ConnectionString = "Server=srv-peda-new;port=5433;Database=selmaner;Search Path=selmaner;uid=selmaner;password=ip1PIB;" // A MODIFIER POUR VOTR BD
              };
              NpgSQLConnect.Open();
